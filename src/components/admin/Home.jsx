    ...
    return (
        <div className="min-h-screen bg-gradient-to-r from-black to-sky-500 text-white">
            <header className="flex justify-between items-center p-3 m-0">
                ...
                <Link to="/EditProfile" className="font-bold hover:underline cursor-pointer">Agregar Informacion</Link>
                <Link to="/" className="font-bold hover:underline cursor-pointer">Gestion de Usuarios</Link>
